...
public enum NotificationType {
    ...
    public String paymentFormat(String auctionName, String paymentType, String orderId, String amount, String date) {
        return String.format(message, auctionName, paymentType, orderId, amount, date);
    }
}
