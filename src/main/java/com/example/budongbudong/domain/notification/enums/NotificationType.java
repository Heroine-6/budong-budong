...
public enum NotificationType {
    ...
    public String paymentRequestFormat(String auctionName, String paymentType, String orderId, String amount, String dueDate) {
        return String.format(message, auctionName, paymentType, orderId, amount, dueDate);
    }
}
