...
(property_id, start_price, min_bid_increment, status, started_at, ended_at, created_at, is_deleted)
VALUES
    (1, 320000000, 32000000, 'SCHEDULED', DATE_ADD(NOW(), INTERVAL 5 DAY), DATE_ADD(NOW(), INTERVAL 6 DAY), NOW(), false),
    (2, 200000000, 20000000, 'SCHEDULED', DATE_ADD(NOW(), INTERVAL 7 DAY), DATE_ADD(NOW(), INTERVAL 8 DAY), NOW(), false),
    (3, 250000000, 25000000, 'SCHEDULED', DATE_ADD(NOW(), INTERVAL 10 DAY), DATE_ADD(NOW(), INTERVAL 11 DAY), NOW(), false),

    (4, 450000000, 45000000, 'OPEN', DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_ADD(NOW(), INTERVAL 1 DAY), NOW(), false),
    (5, 220000000, 22000000, 'OPEN', DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_ADD(NOW(), INTERVAL 1 DAY), NOW(), false),
    (6, 260000000, 26000000, 'OPEN', DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_ADD(NOW(), INTERVAL 2 DAY), NOW(), false),
    (7, 380000000, 38000000, 'OPEN', DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_ADD(NOW(), INTERVAL 1 DAY), NOW(), false),

    (8, 600000000, 60000000, 'CLOSED', DATE_SUB(NOW(), INTERVAL 10 DAY), DATE_SUB(NOW(), INTERVAL 8 DAY), NOW(), false),
    (9, 180000000, 18000000, 'CLOSED', DATE_SUB(NOW(), INTERVAL 9 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY), NOW(), false);
