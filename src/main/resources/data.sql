...
VALUES
    (7, '테스트 아파트 1', '서울시 테스트구 A동', 5, 20, 3, 'APARTMENT', '2015-01-01', '남향, 역세권', 450000000, '2026-03-01', 84.5, 59.8, NOW(), false),
    (7, '테스트 빌라 1', '서울시 테스트구 B동', 2, 5, 2, 'VILLA', '2012-01-01', '조용한 주택가', 280000000, '2026-02-15', 55.2, 42.1, NOW(), false),
    (7, '테스트 오피스텔 1', '서울시 테스트구 C동', 10, 18, 1, 'OFFICETEL', '2020-01-01', '풀옵션', 320000000, '2026-01-20', 40.0, 28.0, NOW(), false),

    (8, '테스트 아파트 2', '서울시 테스트구 D동', 12, 25, 4, 'APARTMENT', '2018-01-01', '초등학교 인접', 620000000, '2026-04-01', 102.3, 74.5, NOW(), false),
    (8, '테스트 빌라 2', '서울시 테스트구 E동', 3, 5, 3, 'VILLA', '2010-01-01', '리모델링 완료', 310000000, '2026-03-10', 60.0, 46.2, NOW(), false),
    (8, '테스트 오피스텔 2', '서울시 테스트구 F동', 15, 20, 1, 'OFFICETEL', '2019-01-01', '신축급', 350000000, '2026-02-01', 42.0, 30.0, NOW(), false),

    (9, '테스트 아파트 3', '서울시 테스트구 G동', 8, 22, 3, 'APARTMENT', '2016-01-01', '공원 뷰', 520000000, '2026-05-01', 89.1, 63.0, NOW(), false),
    (9, '테스트 아파트 4', '서울시 테스트구 H동', 15, 30, 4, 'APARTMENT', '2021-01-01', '신축', 780000000, '2026-06-01', 110.0, 82.0, NOW(), false),
    (9, '테스트 빌라 3', '서울시 테스트구 I동', 1, 4, 2, 'VILLA', '2011-01-01', '마당 있음', 260000000, '2026-02-20', 50.0, 38.0, NOW(), false),
    (9, '테스트 오피스텔 3', '서울시 테스트구 J동', 7, 15, 1, 'OFFICETEL', '2017-01-01', '역 5분', 330000000, '2026-03-01', 41.0, 29.5, NOW(), false);
